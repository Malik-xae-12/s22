...
export default function ClientSummary({ currentUser }: ClientSummaryProps) {
  const projects = MOCK_PROJECTS.filter(
    (p) => p.clientEmail === currentUser?.email,
  );
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-8 text-white">
        ...
        <p className="text-blue-100 mt-2">
          Track your project progress and approvals
        </p>
      </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm text-slate-700">
                      <p>
                        <strong className="text-slate-900">Manager:</strong>{" "}
                        {project.manager}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong className="text-slate-900">Sponsor:</strong>{" "}
                        {project.sponsor}
                      </p>
                    </div>
                  </div>
                ...
                {project.approvalsStatus === "pending" && (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-yellow-800 mb-3">
                      Your review and approval is requested for the next project
                      phase.
                    </p>
